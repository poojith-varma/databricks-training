...
✔ Created derived columns using withColumn()

✔ Performed datatype conversions using cast()

✔ Sorted records using orderBy()

✔ Retrieved limited records using limit()

✔ Practiced DataFrame transformations in Databricks
